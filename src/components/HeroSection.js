...
const AISection = () => {
  return (
    <>
    <section className="py-20  bg-cover bg-no-repeat w-full h-3/4" style={{backgroundImage: `url(${aboutimg})`}}>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center">
          <div className="md:w-1/2">
            ...
            <h3 className="text-lg md:text-xl text-gray-300 mb-6">
              ...
              satisfaction by 30%, slash support expenditures by 40%, and propel
              revenue expansion.
            </h3>
            <div className="flex flex-col md:flex-row space-y-2 md:space-x-4 w-full justify-center">
